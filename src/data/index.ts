    ...
    people: [
      {
        ...
        bio: '<p>My name is Engin Diri and I work for more than 15 years in the IT industry. Started as a Java developer and went there from fronted to backend development until I found my sweet spot in all things related to CI/CD and cloud topics. I love everything about Cloud, Cloud Transformation and Enablement. I am a multi-cloud person with a strong passion for Kubernetes. Furthermore, I am very curious and love to try out new technologies.<br></p>',
        picture: {
          url: 'https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2,f_auto,g_center,q_auto:good/v1/gcs/platform-data-cncf/events/engin%2520diri.jpg',
          path: 'events/engin diri.jpg',
          thumbnail_width: 400,
          thumbnail_height: 400,
          thumbnail_format: 'auto',
          thumbnail_url:
            'https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2,f_auto,g_face,h_400,q_auto:good,w_400/v1/gcs/platform-data-cncf/events/engin%2520diri.jpg',
        },
        personal_twitter: '_ediri',
        company_twitter: '',
      },
    ],
    cta_message:
